...
public class ListViewAdpter extends BaseAdapter
{
    ...
    public ListViewAdpter(final Context context, final ArrayList<String[]> dateList, final int isSelect) {
    ...
    public View getView(final int n, View inflate, final ViewGroup viewGroup) {
        ...
        if (inflate == null) {
            tag = new Holder();
            inflate = this.inflater.inflate(2130903057, (ViewGroup)null);
            tag.img = (ImageView)inflate.findViewById(2131361847);
            tag.tv = (TextView)inflate.findViewById(2131361848);
            tag.playImg = (ImageView)inflate.findViewById(2131361849);
